      ...
      <header className="bg-white/80 backdrop-blur-md border-b border-calm-sage/10 sticky top-0 z-40">
        <div className="container-safe">
          <div className="flex items-center justify-between py-4">
            {/* Logo */}
            <Link to="/landing" className="inline-flex items-center gap-2 font-serif text-2xl text-wellness-text hover:opacity-80 transition-smooth">
              <img src="/AppIcon.jpeg" alt="MANAS360 logo" className="h-9 w-9 rounded-xl object-cover" />
