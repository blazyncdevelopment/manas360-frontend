					...
					<div className="mt-6 space-y-4">
						...
						{isProviderFlow ? (
							<div className="rounded-xl border bg-white p-4" style={{ borderColor: 'var(--color-border-light)' }}>
								<p className="text-sm font-semibold" style={{ color: 'var(--color-ink)' }}>Aadhaar Verification</p>
								...
								<div className="mt-3 grid gap-2 sm:grid-cols-[1fr_auto]">
									<Input
										...
										required
									/>
									<Button type="button" onClick={sendAadhaarOtp} loading={isAadhaarOtpLoading} className="btn btn-primary btn-sm min-h-[48px] sm:self-end">
								...
								{isAadhaarOtpSent && !isAadhaarVerified ? (
									<div className="mt-2 grid gap-2 sm:grid-cols-[1fr_auto]">
										<Input
											...
											required
										/>
										<Button type="button" onClick={verifyAadhaarOtp} className="btn btn-primary btn-sm min-h-[48px] sm:self-end">
											Verify Aadhaar
										</Button>
									</div>
								) : null}
								...
								{isAadhaarVerified ? (
									<p className="mt-2 text-xs font-medium text-success">Aadhaar verified: {maskedAadhaar}</p>
								) : null}

								<div className="my-4 h-px" style={{ background: 'var(--color-divider)' }} />
