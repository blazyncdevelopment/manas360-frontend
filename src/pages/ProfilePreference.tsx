...
export default function PatientProfilePreferences() {
  ...
  const handleSave = () => {
    // In production: PATCH /api/v1/patient/preferences with prefs payload
    console.log("Saving preferences:", JSON.stringify(prefs, null, 2));
    setSaved(true);
  };
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "1.25rem" }}>
          ...
          {activeTab < tabs.length - 1 ? (
            ...
            <button
              ...
              style={{
                border: "none",
                borderRadius: "10px", padding: "0.55rem 1.25rem",
                fontSize: "0.82rem", fontWeight: 700, color: "#fff",
                background: saved ? "#0F6E56" : "#002365", cursor: "pointer",
                fontFamily: "'DM Sans', sans-serif",
