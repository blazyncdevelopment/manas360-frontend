...
const KannadaTherapyLandingPage = () => {
    ...
    return (
        <div className="landing-page-root" style={{ minHeight: '100vh', backgroundColor: "#F8FAFC", color: '#1A1A2E', paddingBottom: '60px' }}>
            ...
            <div style={{ background: '#326B54', padding: '80px 20px', textAlign: 'center' }}>
                <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                    <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 font-serif text-white">
                        ಕನ್ನಡದಲ್ಲಿ ಮಾನಸಿಕ ಸಮಾಲೋಚನೆ
                    </h1>
                    <p className="text-white" style={{ maxWidth: '600px', margin: '0 auto 2rem auto', lineHeight: '1.5', opacity: 0.9, fontSize: '1.05rem' }}>
                        ಭಾರತದ ಅತ್ಯುತ್ತಮ ಕನ್ನಡ ಮಾತನಾಡುವ ಮನಶ್ಶಾಸ್ತ್ರಜ್ಞರೊಂದಿಗೆ ಸಂಪರ್ಕ ಸಾಧಿಸಿ. ಮಾನಸಿಕ ಆರೋಗ್ಯ ತಜ್ಞರು ಈಗ ನಿಮ್ಮ ಸ್ವಂತ ಭಾಷೆಯಲ್ಲಿ ಲಭ್ಯವಿದ್ದಾರೆ.
                    </p>
                    <div className="flex justify-center items-center gap-4">
                        ...
                        >
                            ಉಚಿತ ಮೌಲ್ಯಮಾಪನವನ್ನು ಪ್ರಾರಂಭಿಸಿ <ArrowRight className="inline-block ml-1" size={16} />
                        </Button>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-6xl mx-auto px-6 py-12">
                <h2 className="text-2xl font-bold mb-8 text-center text-[#0B2D5E]">ಉನ್ನತ ಶ್ರೇಣಿಯ ಮನಶ್ಶಾಸ್ತ್ರಜ್ಞರು (Top Rated Psychologists)</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                        { name: 'ಡಾ. ಅಂಜಲಿ ಶರ್ಮಾ', spec: 'ಕ್ಲಿನಿಕಲ್ ಸೈಕಾಲಜಿಸ್ಟ್ (Clinical Psychologist)', area: 'ಬೆಂಗಳೂರು', rating: '4.9', reviews: 124, img: 'https://i.pravatar.cc/150?u=anjali' },
                        { name: 'ಡಾ. ವಿಕ್ರಮ್ ರೆಡ್ಡಿ', spec: 'ಸಿಬಿಟಿ ತಜ್ಞ (CBT Specialist)', area: 'ಮೈಸೂರು', rating: '4.8', reviews: 98, img: 'https://i.pravatar.cc/150?u=vikram' },
                        { name: 'ಸ್ನೇಹಾ ಪಾಟೀಲ್', spec: 'ಸಮಾಲೋಚನಾ ಮನಶ್ಶಾಸ್ತ್ರಜ್ಞ (Counseling Psychologist)', area: 'ಹುಬ್ಬಳ್ಳಿ', rating: '4.9', reviews: 156, img: 'https://i.pravatar.cc/150?u=sneha' },
                    ].map((doc, i) => (
                        <div key={i} className="p-8 rounded-3xl bg-white/95 border border-slate-200 shadow-xl flex flex-col items-center text-center backdrop-blur-md hover:-translate-y-1 transition-transform">
                            ...
                            <p className="text-[#666680] text-sm flex items-center justify-center gap-1 mb-4">
                                <MapPin className="w-3.5 h-3.5 text-[#0B2D5E]" /> {doc.area}, ಕರ್ನಾಟಕ
                            </p>
                            <div className="flex items-center gap-1 mb-6">
                                <Star className="w-4 h-4 text-yellow-500 fill-current" />
                                <span className="font-bold text-[#1A1A2E]">{doc.rating}</span>
                                <span className="text-[#666680] text-sm">({doc.reviews} ವಿಮರ್ಶೆಗಳು)</span>
                            </div>
                        </div>
                    ))}
                </div>
            ...
            <div className="text-center py-12">
                ...
                >
                    ಉಚಿತ ಮೌಲ್ಯಮಾಪನವನ್ನು ಪ್ರಾರಂಭಿಸಿ (Free Screening)
                </Button>
            </div>
...
export default KannadaTherapyLandingPage;
