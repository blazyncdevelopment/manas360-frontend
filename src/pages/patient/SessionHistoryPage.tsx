              ...
              <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
                ...
                <div className="rounded-2xl bg-white/90 p-4">
                  ...
                  <p className="mt-1 text-sm font-semibold text-charcoal capitalize">
                    {(smartMatchSummary.preferences as any)?.providerType?.toLowerCase() || 'General Session'}
                  </p>
                </div>
                            ...
                            {isCompleted ? (
                              <>
                                <Link
                                  ...
                                  className="inline-flex items-center gap-1.5 rounded-lg bg-teal-50 px-4 py-1.5 text-xs font-semibold text-teal-700 transition hover:bg-teal-100"
                                >
                                  View Details
                                </Link>
                                <button
